...
const Hotel = () => {
  ...
  const no_of_days = dayDifference(dates[0].endDate, dates[0].startDate);
            ...
            <div className="hotelWrapper">
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  <h1>Perfect for a {no_of_days}-night stay!</h1>
                  <span>
                    Located in the real heart of Krakow, this property has an
                    excellent location score of 9.8!
                  </span>
                  <h2>
                    <b>${data.cheapestPrice * no_of_days * options.room}</b> (
                    {no_of_days} nights)
                  </h2>
